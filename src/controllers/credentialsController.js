...
function createCredentials(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var credentialData, authorization;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    credentialData = req.body;
                    authorization = req.headers.authorization;
                    return [4 /*yield*/, (0, credentialsService_1.create)(authorization, credentialData)];
                case 1:
                    _a.sent();
                    res.send("deu certo");
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
                    authorization = req.headers.authorization;
                    return [4 /*yield*/, (0, credentialsService_1.get)(authorization, id)];
                case 1:
                    credential = _a.sent();
                    res.send(credential);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
                    authorization = req.headers.authorization;
                    return [4 /*yield*/, (0, credentialsService_1.deleteCredential)(authorization, id)];
                case 1:
                    credential = _a.sent();
