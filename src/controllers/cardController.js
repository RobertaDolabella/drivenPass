...
function createCards(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var cardData, authorization;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cardData = req.body;
                    authorization = req.headers.authorization;
                    return [4 /*yield*/, (0, cardService_1.create)(authorization, cardData)];
                case 1:
                    _a.sent();
                    res.sendStatus(201);
                    return [2 /*return*/];
...
function getCard(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var id, authorization, card;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
                    authorization = req.headers.authorization;
                    return [4 /*yield*/, (0, cardService_1.get)(authorization, id)];
                case 1:
                    card = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
                    authorization = req.headers.authorization;
                    return [4 /*yield*/, (0, cardService_1.deleteCard)(authorization, id)];
                case 1:
                    _a.sent();
