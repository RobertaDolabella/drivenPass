...
function create(authorization, credentialData) {
    return __awaiter(this, void 0, void 0, function () {
        var token, user, userId, encryptedPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    token = authorization === null || authorization === void 0 ? void 0 : authorization.replace("Baerer ", "");
                    console.log(credentialData);
                    return [4 /*yield*/, (0, credentialsRepository_1.checkToken)(token)];
                case 1:
                    user = _a.sent();
                    isTokenActivate(user);
                    userId = user.id;
                    return [4 /*yield*/, thereIsOtherCredential(userId, credentialData)];
                case 2:
                    _a.sent();
                    encryptedPassword = encryptPassword(credentialData.credentialPassword);
                    return [4 /*yield*/, createCredential(userId, credentialData, encryptedPassword)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function get(authorization, id) {
    return __awaiter(this, void 0, void 0, function () {
        var idCredential, token, user, userId, credential;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    idCredential = Number(id);
                    token = authorization === null || authorization === void 0 ? void 0 : authorization.replace("Baerer ", "");
                    return [4 /*yield*/, (0, credentialsRepository_1.checkToken)(token)];
                case 1:
                    user = _a.sent();
                    isTokenActivate(user);
                    userId = user.id;
                    return [4 /*yield*/, (0, credentialsRepository_1.getCredential)(userId, idCredential)];
                case 2:
                    credential = _a.sent();
...
function deleteCredential(authorization, id) {
    return __awaiter(this, void 0, void 0, function () {
        var idCredential, token, user, userId, credential, deletecredential;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    idCredential = Number(id);
                ...
                case 2:
                    credential = _a.sent();
                    thereIsACredential(credential);
                    return [4 /*yield*/, (0, credentialsRepository_1.deleteThisCredential)(userId, idCredential)];
                case 3:
                    deletecredential = _a.sent();
                    return [2 /*return*/, credential];
            }
        });
    });
...
function thereIsOtherCredential(userId, credentialData) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, credentialsRepository_1.checkCredential)(userId, credentialData)];
                case 1:
                    credential = _a.sent();
...
function encryptPassword(password) {
    ...
    var cryptrCredentialPassword = new cryptr_1["default"]("passwordCrypt");
    var encryptedCredentialPassword = cryptrCredentialPassword.encrypt(password);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, credentialsRepository_1.createNewCredential)(userId, credentialData, encryptedPassword)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
