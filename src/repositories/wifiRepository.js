...
function checkWifi(userId, wifiData) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.wifis.findMany({ where: { userId: userId, title: wifiData.title } })];
                case 1:
                    wifi = _a.sent();
...
function checkToken(token) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.users.findFirst({ where: { token: token } })];
                case 1:
                    user = _a.sent();
...
function createNewWifi(userId, wifiData, encryptedPassword) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.wifis.create({
                        data: {
...
function getWifi(userId, id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.wifis.findMany({ where: { id: id, userId: userId } })];
                case 1:
                    wifi = _a.sent();
                    return [2 /*return*/, wifi];
            }
...
function getWifis(userId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.wifis.findMany({ where: { userId: userId } })];
                case 1:
                    wifis = _a.sent();
...
function deleteThisWifi(userId, id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.wifis["delete"]({ where: { id: id } })];
                case 1:
                    wifi = _a.sent();
                    return [2 /*return*/, wifi];
            }
...
var wifiRepository = {
    ...
    createNewWifi: createNewWifi,
    getWifi: getWifi,
    deleteThisWifi: deleteThisWifi,
    getWifis: getWifis
};
