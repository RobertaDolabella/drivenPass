...
function checkCredential(userId, credentialData) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.credentials.findMany({ where: { userId: userId, title: credentialData.title } })];
                case 1:
                    credential = _a.sent();
...
function createNewCredential(userId, credentialData, encryptedPassword) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.credentials.create({
                        data: {
...
function getCredential(userId, id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.credentials.findMany({ where: { id: id, userId: userId } })];
                case 1:
                    credential = _a.sent();
                    return [2 /*return*/, credential];
            }
...
function deleteThisCredential(userId, id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.credentials["delete"]({ where: { id: id } })];
                case 1:
                    credential = _a.sent();
                    return [2 /*return*/, credential];
            }
...
var credentiaRepository = {
    ...
    deleteThisCredential: deleteThisCredential
};
