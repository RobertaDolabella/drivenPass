...
function checkCard(userId, cardData) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.cards.findMany({ where: { userId: userId, title: cardData.title } })];
                case 1:
                    card = _a.sent();
...
function createNewCard(userId, cardData, encryptedPassword, encryptedCvv) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.cards.create({
                        data: {
...
function getCard(userId, id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.cards.findMany({ where: { id: id, userId: userId } })];
                case 1:
                    card = _a.sent();
                    return [2 /*return*/, card];
            }
...
function deleteThisCard(userId, id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.prismadata.cards["delete"]({ where: { id: id } })];
                case 1:
                    card = _a.sent();
                    return [2 /*return*/, card];
            }
